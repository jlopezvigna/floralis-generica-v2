                ...
                <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        <h1 className="h1 mb-4" data-aos="fade-up">
                            We build your ideas in real projects
                        </h1>
                        <p className="text-xl text-gray-500 mb-8" data-aos="fade-up" data-aos-delay="200">
                            With our expert teams, led by AI engineers and software engineers, we're building the next
                            generation of applications for our customers. Our mission is to assist them in achieving
                            their objectives and amplifying their business potential.
                        </p>
                        <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                            <div data-aos="fade-up" data-aos-delay="400">
                                <BookMeeting className="w-full mb-4 sm:w-auto sm:mb-0" />
                            </div>
                            <div data-aos="fade-up" data-aos-delay="600">
                                {/* TODO: Add the link to scrool */}
                                <Button href="#our-services" variant="outline" className="w-full sm:w-auto sm:ml-4">
                                    Learn more
                                </Button>
                            </div>
                        </div>
